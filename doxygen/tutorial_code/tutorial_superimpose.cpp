...
int main()
{
    ...
    /**
     * We allocate the SICAD class passing all the parameters, the folder path
     * containing the shader code (don't worry, we provide basic shaders as
     * well!) and finally that we want to see the rendering on screen, i.e
     * we don't want to do off-screen rendering.
     *
